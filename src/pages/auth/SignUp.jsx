...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        const assignedRole = data.user?.user_metadata?.role || role;
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f2f0e9] selection:bg-white/30 selection:text-white px-6 font-body py-12">
      ...
      >
        <div className="container-editorial p-10 lg:p-12">
          ...
          <div className="flex bg-white p-1 rounded-full mb-8">
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-4">
              <button
                ...
                className={`w-full ${loading || success ? 'bg-white text-charcoal-light cursor-not-allowed shadow-none' : 'w-full bg-charcoal text-[#f2f0e9] hover:bg-charcoal/90'} py-4 rounded-full font-medium text-lg transition-all duration-500`}
              >
          ...
          <p className="text-center mt-10 text-charcoal-light text-sm font-medium">
            ...
            <Link to="/auth/login" className="text-charcoal hover:text-charcoal transition-colors underline decoration-charcoal/20 hover:decoration-clay/50 underline-offset-4 pl-1">
              Sign in instead
            </Link>
          </p>
        </div>
